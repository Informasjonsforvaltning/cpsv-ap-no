...
For å kunne beskrive krav som skal oppfylles og kravoppfyllelse på en strukturert og maskinlesbar måte, bør https://informasjonsforvaltning.github.io/cccev-ap-no/[Spesifikasjon for beskrivelse av krav og kravoppfyllelse (CCCEV-AP-NO) &#x29C9;, window="_blank", role="ext-link"] brukes. CCCEV-AP-NO er basert på https://github.com/SEMICeu/CCCEV[EUs __Core Criterion and Core Evidence Vocabulary__ (CCCEV) &#x29C9;, window="_blank", role="ext-link"]. 
