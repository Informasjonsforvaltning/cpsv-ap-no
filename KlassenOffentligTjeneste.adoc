...
|Remark 1| Norwegian extension: The value shall be chosen from http://purl.org/adms/status/[ADMS Status Vocabulary (i RDF)].
|Merknad 2 | Norsk utvidelse: Kravsnivå endret fra valgfri til anbefalt.
...
|Remark 1 | The value shall be chosen from a controlled vocabulary when the value.
|Merknad 2 | Norsk utvidelse: Kravsnivå endret fra valgfri til anbefalt.
|Remark 2 | Norwegian extension: Minimum requirement changed from optional to recommended.
|Eksempel|
|===
