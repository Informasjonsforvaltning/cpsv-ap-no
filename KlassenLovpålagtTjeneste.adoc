...
==== Lovpålagt tjeneste – forvaltningsnivå (cpsvno:governmentLevel) [[LovpålagtTjeneste-forvaltningsnivå]]

[cols="30s,70d"]
|===
| _English name_ | _government level_
| URI | cpsvno:governmentLevel
| Verdiområde / _Range_ | https://data.norge.no/specification/skos-ap-no-begrep#Begrep[skos:Concept &#x29C9;, window="_blank", role="ext-link"]
| Anvendelse / _Usage note_ |  Egenskapen brukes til å referere til begrep hentet fra et kontrollert vokabular som forklarer forvaltningsnivået av tjenesten.

_This property refers to concept chosen from a controlled vocabulary which explains the government level of the service._
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ |  Anbefalt / _Recommended_
| Eksempel / _Example_ | statlig, fylkeskommunal, kommunal

__national, regional, local__
|===
...
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Anbefalt / _Recommended_
| Merknad / _Note_ | Verdien BØR velges fra https://psi.norge.no/los/[Los – felles vokabular for å kategorisere og beskrive offentlige tjenester og ressurser &#x29C9;, window="_blank", role="ext-link"].
...
| Verdiområde / _Range_ | https://data.norge.no/specification/skos-ap-no-begrep#Begrep[skos:Concept &#x29C9;, window="_blank", role="ext-link"]
| Anvendelse / _Usage note_ |  Egenskapen brukes til å referere til et eller flere begrep som er brukt til å klassifisere tjenesten, begrep som _ikke_ er eller _ikke_ kan være inkludert i andre egenskaper som <<LovpålagtTjeneste-temaområde>>, <<LovpålagtTjeneste-sektor>> osv.
