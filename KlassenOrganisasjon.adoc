...
| Subklasse av / _Subclass of_ | <<Aktør, foaf:Agent>>
...
==== Organisasjon – foretrukket navn (skos:prefLabel) [[Organisasjon-foretrukket-navn]]
...
Eksempel i RDF Turtle: se tilsvarende eksempel under <<OffentligOrganisasjon-dekningsområde>>.
...
| URI | locn:address
| Verdiområdet / _Range_ | <<Adresse, locn:Address>>
...
| URI | cv:participates
| Verdiområdet / _Range_ | <<Deltagelse, cv:Participation>>
