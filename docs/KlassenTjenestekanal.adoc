...
|Beskrivelse |Brukes til å oppgi den estimerte behandlingstiden via denne kanalen. 
...
|URI|cpsv:hasInput
|Range|cv:Evidence
|Beskrivelse|Brukes til å referere til dokumentasjonskrav som er spesifikk for den aktuelle tjenestekanalen.
