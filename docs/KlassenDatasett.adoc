...
|Anvendelse|Egenskapen brukes til å referere til tjenester. #NB! for vag beskrivelse#
|Usage note|This property links a Dataset to the Service. #NB! for vag beskrivelse#
|Multiplisitet|0..n
|Kravnivå|Valgfri/Optional
|Merknad|
|Eksempel|
