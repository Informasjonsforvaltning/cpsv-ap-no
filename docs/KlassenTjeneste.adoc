...
==== Tjeneste – har mulig tjenesteresultat (cpsvno:hasPossibleOutput) [[Tjeneste-har-mulig-tjenesteresultat]]
...
==== Tjeneste – har påkrevd dokumentasjon (cpsvno:hasRequiredEvidence) [[Tjeneste-har-påkrevd-dokumentasjon]]
