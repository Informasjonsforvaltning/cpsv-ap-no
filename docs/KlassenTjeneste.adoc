...
|URI |dct:requires 
|Range |cpsvno:Service
|Anvendelse | Egenskapen brukes til å referere til en eller flere andre tjenester som tjenesten krever utført først, eller som tjenesten på en eller annen måte bruker resultat fra.  
...
|Multiplisitet |0..n 
|Kravnivå  |Valgfri/Optional 
|Merknad 1 |De mulige verdiene for egenskapen velges fra EUs kontrollerte vokabular https://op.europa.eu/en/web/eu-vocabularies/concept-scheme/-/resource?uri=http://publications.europa.eu/resource/authority/data-theme[Data theme].
