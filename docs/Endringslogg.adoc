...
* Klassen er ikke lenger en subklasse av klassen Datasett (dcat:Dataset). For å kunne knytte et gitt tjenesteresultat til et datasett, er det innført en ny egenskap <<Tjenesteresultat-er-del-av>>. 
