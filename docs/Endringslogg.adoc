...
* <<MuligTjenesteresultat>>: føyet til for å kunne dekke behov for å beskrive hva som er mulige resultater fra en tjeneste (ettersom klassen cv:Output i CPSV-AP skal representere et konkret stykke resultat fra en gitt tjeneste, og ikke hva som er mulige resultater).
...
** Egenskapene <<OffentligTjeneste-harPåkrevdDokumentasjon>> og <<OffentligTjeneste-harMuligTjenesteresultat>> føyet til, for å kunne beskrive påkrevd dokumentasjon til, og mulig resultat fra en offentlig tjeneste.
...
** Egenskapene <<Tjeneste-harPåkrevdDokumentasjon>> og <<Tjeneste-harMuligTjenesteresultat>> føyet til, for å kunne beskrive påkrevd dokumentasjon til, og mulig resultat fra en tjeneste.
