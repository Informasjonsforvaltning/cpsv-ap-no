...
** Egenskapene «Offentlig tjeneste – har dokumentasjonskrav (cpsv:hasInput)» og «Offentlig tjeneste – produserer (cpsv:produces)» utgått. 
...
** Egenskapene «Tjeneste – har dokumentasjonskrav (cpsv:hasInput)» og «Tjeneste – produserer (cpsv:produces)» utgått. 
