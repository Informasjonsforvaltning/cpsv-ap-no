...
** Egenskapene «Offentlig tjeneste - har påkrevd dokumentasjon (cpsvno:hasRequiredEvidence)» og «Offebtlig tjeneste- har mulig tjenesteresultat (cpsvno:hasPossibleOutput)» er føyet til, for å kunne beskrive påkrevd dokumentasjon til, og mulig tjenesteresultat fra en offentlig tjeneste.
