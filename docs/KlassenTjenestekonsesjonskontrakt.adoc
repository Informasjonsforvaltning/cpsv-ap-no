...
==== Tjenestekonsesjonskontrakt – har leverandør (cv:hasEconomicOperator) [[Tjenestekonsesjonskontrakt-har-leverandør]]
...
==== Tjenestekonsesjonskontrakt – har oppdragsgiver (cv:hasContractingAuthority) [[Tjenestekonsesjonskontrakt-har-oppdragsgiver]]
...
==== Tjenestekonsesjonskontrakt – etablert i henhold til (cv:establishedUnder) [[Tjenestekonsesjonskontrakt-er-etablert-iht]]
