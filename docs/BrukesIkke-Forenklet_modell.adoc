...
image::images/ForenkletModell-CPSV-AP-NO.png[alt="UML-diagram med 23 klasser og relasjoner imellom klassene. Klassene og relasjonene er forklart i spesifikasjonen."]
