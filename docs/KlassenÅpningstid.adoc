...
|Anvendelse| Klassen brukes til å beskrive detaljer i åpningstid på en strukturert måte.
...
|Anvendelse| Egenskapen brukes til å oppgi dag i uke som åpningsspesifikasjonen gjelder for.
...
|Anvendelse| Egenskapen brukes til å oppgi fra og med når den aktuelle åpningstid gjelder.
...
|Range|rdfs:Literal typed as xsd:date or xsd:dateTime
|Anvendelse| Egenskapen brukes til å oppgi til og med når den aktuelle åpningstiden gjelder.
...
|Anvendelse| Egenskapen brukes til å oppgis stengningstidspunkt.
...
|URI|schema:opens
|Range|rdfs:Literal typed as xsd:time
|Anvendelse| Egenskapen brukes til å oppgi åpningstidspunkt.
