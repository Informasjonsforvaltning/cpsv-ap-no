...
==== Offentlig tjeneste – har mulig resultat (cpsvno:hasPossibleResult) [[OffentligTjeneste-harMuligResultat]]

[cols="30s,70d"]
|===
| _English name_ | _has possible result_
| URI | cpsvno:hasPossibleResult
| Verdiområde / _Range_ | cpsvno:PossibleResult
...
-----
<skjenkebevillingBrønnøy> a cpsv:PublicService ;
   cpsvno:hasPossibleResult <bevilling> , <avslag> .
-----
