...
|Remark | Norwegian extension: Minimum requirement changed from mandatory to recommended, such that the specification may also be used to describe services that are not public services.
