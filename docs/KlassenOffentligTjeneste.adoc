...
==== Offentlig tjeneste – ansvarlig organisasjon (cv:hasCompetentAuthority) [[OffentligTjeneste-ansvarlig-organisasjon]]
...
==== Offentlig tjeneste – har mulig tjenesteresultat (cpsvno:hasOutputType) [[OffentligTjeneste-har-mulig-tjenesteresultat]]
...
-----
<skjenkebevillingBrønnøy> a cpsv:PublicService ;
   cv:contactPoint <eksKontaktPunkt> ; .
-----
...
| Merknad / _Note_ | Norsk utvidelse: Ikke eksplisitt spesifisert i CPSV-AP. Begrunnelse: det er behov for å kunne referere til begrep som er viktig for å forstå tjenesten.
...
<skjenkebevillingBrønnøy> a cpsv:PublicService ;
   dct:spatial <http://publications.europa.eu/resource/authority/country/NOR> , # Norge
      <https://sws.geonames.org/3159955/> ; # Brønnøy kommune
   .
----

==== Offentlig tjeneste – har dokumentasjonskrav (cv:hasInputType) [[OffentligTjeneste-har-dokumentasjonskrav]]
...
==== Offentlig tjeneste – realiserer (cpsvno:realizes) [[OffentligTjeneste-realiserer]]

[cols="30s,70d"]
|===
| _English name_ | _realizes_
| URI | dct:type
| Verdiområde / _Range_ | cpsvno:realizes
| Anvendelse / _Usage note_ |  Egenskapen brukes til å referere til en lovpålagt tjeneste som tjenesten realiserer.

_This property is used to refer to the Staturoy service that this service realizes._
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Anbefalt / _Recommended_
| Merknad / _Note_ |  Norsk utvidelse: Kravnivå er endret fra valgfri til anbefalt.
...
| Kravnivå / _Requirement level_ | Anbefalt / _Recommended_
| Merknad 1 / _Note 1_ | Norsk utvidelse: Verdien SKAL velges fra EUs kontrollerte vokabular https://op.europa.eu/en/web/eu-vocabularies/concept-scheme/-/resource?uri=http://publications.europa.eu/resource/authority/distribution-status[__Distribution status__ &#x29C9;, window="_blank", role="ext-link"].
...
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Anbefalt / _Recommended_
| Merknad 1 / _Note 1_ | Norsk utvidelse: Verdien BØR velges fra https://psi.norge.no/los/[Los – felles vokabular for å kategorisere og beskrive offentlige tjenester og ressurser &#x29C9;, window="_blank", role="ext-link"].

__Norwegian extension: The value SHOULD be chosen from https://psi.norge.no/los/[Los &#x29C9;, window="_blank", role="ext-link"].__
| Merknad 2 / _Note 2_ |  Norsk utvidelse: Kravnivå  endret fra valgfri til anbefalt.
...
==== Offentlig tjeneste – er beskrevet ved (cccevno:isDescribedBy) [[OffentligTjeneste-er-beskrevet-ved]]
...
==== Offentlig tjeneste – er del av (dct:isPartOf) [[OffentligTjeneste-er-del-av]]
...
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
| Merknad 1 / _Note 1_ | Denne er den inverse av egenskapen <<OffentligTjeneste-har-del>>.

_This is the inverse of the property <<OffentligTjeneste-har-del>>._
| Merknad 2 / _Note 2_ | Norsk utvidelse: Ikke eksplisitt tatt med i CPSV-AP.

_Norwegian extension: Not explicitly specified in CPSV-AP._
|===

==== Offentlig tjeneste – er gruppert ved (cv:isGroupedBy) [[OffentligTjeneste-er-gruppert-ved]]
...
| Anvendelse / _Usage note_ |  Egenskapen brukes til å referere til en eller flere hendelser som tjenesten grupperes ved.
...
==== Offentlig tjeneste – er klassifisert under (cv:isClassifiedBy) [[OffentligTjeneste-er-klassifisert-under]]
...
| Verdiområde / _Range_ | https://data.norge.no/specification/skos-ap-no-begrep#Begrep[skos:Concept &#x29C9;, window="_blank", role="ext-link"]
| Anvendelse / _Usage note_ |  Egenskapen brukes til å referere til et eller flere begrep som er brukt til å klassifisere tjenesten, begrep som _ikke_ er eller _ikke_ kan være inkludert i andre egenskaper som <<OffentligTjeneste-temaområde>>, <<OffentligTjeneste-sektor>> osv.
...
==== Offentlig tjeneste – er tilgjengelig via (cv:hasChannel) [[OffentligTjeneste-er-tilgjengelig-via]]
...
==== Offentlig tjeneste – følger regel (cpsv:follows) [[OffentligTjeneste-følger-regel]]
...
==== Offentlig tjeneste – har del (dct:hasPart) [[OffentligTjeneste-har-del]]
...
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
| Merknad 1 / _Note 1_ | Dette er den inverse av egenskapen <<OffentligTjeneste-er-del-av>>.

_This is the inverse of the property <<OffentligTjeneste-er-del-av>>._
| Merknad 2 / _Note 2_ | Norsk utvidelse: Ikke eksplisitt tatt med i CPSV-AP.
...
==== Offentlig tjeneste – relatert tjeneste (cv:relatedService) [[OffentligTjeneste-relatert-tjeneste]]
