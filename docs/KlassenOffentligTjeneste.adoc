...
==== Offentlig tjeneste – har mulig tjenesteresultat (cpsvno:hasPossibleOutput) [[OffentligTjeneste-har-mulig-tjenesteresultat]]
...
==== Offentlig tjeneste – har påkrevd dokumentasjon (cv:hasInputType) [[OffentligTjeneste-har-påkrevd-dokumentasjon]]
