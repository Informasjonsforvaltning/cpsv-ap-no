...
|Merknad 1| Bruk <<PrivatTjeneste>> hvis tjenesten som beskrives er en privat tjeneste.
|Remark 1| Use <<PrivatTjeneste>> if the service described is a private service.
...
|Remark 2| Norwegian extension: Minimum requirement changed from mandatory to recommended, such that the specification may also be used e.g. to describe private services.
