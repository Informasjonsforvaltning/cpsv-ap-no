...
|Merknad |Norsk utvidelse: Kravnivået er endret fra obligatorisk til anbefalt, for at spesifikasjonen også kal kunne brukes til å beskrive tjenester ikke er offentlige tjenester.
...
|Anvendelse| Egenskapen brukes til å oppgi en tekstlig beskrivelse av tjenesten. Denne egenskapen kan gjentas når beskrivelsen finnes i flere språk.
...
==== Offentlig tjeneste – kontaktpunkt (cv:hasContactPoint) [[OffentligTjeneste-kontaktpunkt]]
...
|URI|dct:title
|Range| rdf:langString
|Anvendelse| Egenskapen brukes til å oppgi det offisielle navnet på tjenesten. Denne egenskapen kan gjentas når navnet finnes i flere språk.
...
|Merknad 2| Norsk utvidelse: kravnivå et endret fra valgfri til obligatorisk og multiplisitet fra 0..n til 1..n. Dette fordi enhver tjeneste skal resultere i noe.
...
==== Offentlig tjeneste – dokumentasjonskrav (cpsv:hasInput) [[OffentligTjeneste-dokumentasjonskrav]]
...
|Anvendelse| Egenskapen brukes til å referere til en annen tjeneste som denne tjenesten er en del av.
...
|Remark| Norwegian extension: Not specified in CSPV-AP.
...
|Anvendelse| Egenskapen brukes til å knytte til andre aktører som er deltagende i å levere tjenesten.
...
|Range|skos:Concept
|Anvendelse| Egenskapen brukes til å referere til et eller flere begreper som er brukt til å klassifisere tjenesten, begreper som _ikke_ er eller _ikke_ kan være inkludert i andre egenskaper som <<OffentligTjeneste-temaområde>>, <<OffentligTjeneste-næringsgruppering>> osv.
|Usage note| This property allows to classify the Public Service with any Concept, other than those already foreseen and defined explicitely in the CPSV-AP (<<OffentligTjeneste-temaområde>>, <<OffentligTjeneste-næringsgruppering>> etc.
|Multiplisitet|0..n
|Kravnivå | Valgfri/Optional
|Merknad|
...
|URI|dct:requires
|Range|cpsvno:Service
|Anvendelse| Egenskapen brukes til å referere til en eller flere andre tjenester som denne tjenesten krever utført først, eller som denne tjenesten på en eller annen måte bruker resultat fra.
...
==== Offentlig tjeneste – vilkår (cv:holdsRequirement) [[OffentligTjeneste-vilkår]]
...
|Anvendelse| Egenskapen brukes til å referere til vilkår knyttet til behov for eller bruk av tjenesten.
