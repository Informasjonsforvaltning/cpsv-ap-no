...
|Multiplisitet|0..1
|Kravsnivå|Anbefalt/Recommended
|Merknad|Verdien skal velges fra EUs kontrollerte vokabular https://op.europa.eu/s/teOr[Valuta].
|Remarks|The value shall be chosen from EU's controlled vocabulary https://op.europa.eu/s/teOr[Currency].
|Eksempel|Se under <<OffentligTjeneste-gebyr>>.
|===
...
|URI|cv:isDefinedBy
|Range|foaf:Agent
|Anvendelse|Brukes til å referere til en eller flere aktører (inkl. offentlige organisasjon) som bestemmer gebyr for en tjeneste.
