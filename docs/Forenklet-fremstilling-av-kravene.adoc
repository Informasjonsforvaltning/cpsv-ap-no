...
image::images/CPSV-AP-NO-forenklet-fremstilling.png[alt="Forenklet UML-diagram med 9 klasser, deres egenskaper og relasjoner til hverandre. Innholdet i diagrammet er forklart i teksten."]
...
* En tjeneste / offentlig tjeneste SKAL alltid ha et eller flere *mulige tjenesteresultat* som KAN skape en eller flere nye hendelser. 
