...
.Obligatoriske opplysningstyper som en beskrivelse av Tjeneste, Offentlig tjeneste og Lovpålagt tjeneste SKAL inneholde
...
.Anbefalte opplysningstyper som en beskrivelse av Tjeneste, Offentlig tjeneste og Lovpålagt tjeneste BØR inneholde
[cols="20s,65d,15d", options="header"]
|===
...
.Valgfrie opplysningstyper som en beskrivelse av Tjeneste, Offentlig tjeneste og Lovpålagt tjeneste KAN inneholde
[cols="20s,65d,15d", options="header"]
|===
...
.Obligatoriske opplysningstyper som en beskrivelse av Hendelse, Livshendelse og virksomhetshendelse SKAL inneholde
[cols="20s,65d,15d", options="header"]
|===
| Obligatorisk | Forklaring | Ref. til kap. <<Spesifikasjon-per-klasse>>
...
.Anbefalte opplysningstyper som en beskrivelse av Hendelse, Livshendelse og virksomhetshendelse BØR inneholde
[cols="20s,65d,15d", options="header"]
|===
| Anbefalt | Forklaring | Ref. til kap. <<Spesifikasjon-per-klasse>>
...
.Valgfrie opplysningstyper som en beskrivelse av Hendelse, Livshendelse og virksomhetshendelse KAN inneholde
[cols="20s,65d,15d", options="header"]
|===
| Valgfri | Forklaring | Ref. til kap. <<Spesifikasjon-per-klasse>>
