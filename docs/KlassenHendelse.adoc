...
==== Hendelse – kontaktpunkt (cv:contactPoint) [[Hendelse-kontaktpunkt]]
...
==== Hendelse – kan sette i gang (cpsvno:mayTrigger) [[Hendelse-kan-sette-i-gang]]
...
==== Hendelse – er beskrevet ved (cccevno:isDescribedBy) [[Hendelse-er-beskrevet-ved]]
...
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
| Merknad / _Note_ | Norsk utvidelse: Verdien SKAL velges fra det felles kontrollerte vokabularet https://data.norge.no/vocabulary/event-type[Hendelsestype &#x29C9;, window="_blank", role="ext-link"], når verdien finnes i vokabularet.

 __Norwegian extension: The value MUST be chosen from the common controlled vocabulary https://data.norge.no/vocabulary/event-type[Event type &#x29C9;, window="_blank", role="ext-link"], when the value is in the vocabulary.__
|===
