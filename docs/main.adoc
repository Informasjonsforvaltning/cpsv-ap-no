...
*Versjon*: #forberedelse til v.0.9#  +
*Publisert*: #under utvikling# (Se <<Endringslogg>>) +
*Oppdatert*: #løpende oppdatert inntil dette blir "v.0.9"# +
...
include::KlassenPrivatAktør.adoc[]

include::KlassenPrivatTjeneste.adoc[]
