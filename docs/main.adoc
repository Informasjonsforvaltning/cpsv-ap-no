...
*Status*: #under ferdigstilling (avventer ferdigstilling av EUs CPSV-AP som denne er basert på)# +
*Versjon*: #utkast til v.1.0# +
*Publisert*: 2022-11-01 +
*Oppdatert*: 2022-12-12 +
*Gjeldende versjon*: <ingen> +
*Forrige versjon*: <ingen> +
*Redaktørens utkast*: https://informasjonsforvaltning.github.io/cpsv-ap-no/ +
*Veileder*: <ingen> +
// *Valideringsverktøy*: https://data.norge.no/validator (ved å oppgi URLen til denne https://raw.githubusercontent.com/Informasjonsforvaltning/cpsv-ap-no/develop/shacl/CPSV-AP-NO_shacl_shapes_v09xx.ttl[shacl-fil] som "Regelsett lenke", [yellow-background]#shacl-filen er under utvikling#)
...
include::KlassenAdministrativEnhet.adoc[]
...
include::KlassenKonsesjonskontrakt.adoc[]
