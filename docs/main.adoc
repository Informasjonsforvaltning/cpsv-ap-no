...
*Publisert*: #under utarbeidelse (v.2)#; 2026-05-05 (v.1.2); 2023-09-08 (v.1.0) +
*Oppdatert*: #under utarbeidelse (v.2)#; 2026-05-05 (v.1.2); 2025-11-05 (v.1.1.x) +
...
include::KlassenTjenesteresultattypeliste.adoc[]
