...
|Merknad 1|For aktør som er en offentlig organisasjon skal <<OffentligOrganisasjon>> brukes. For privat aktør skal <<PrivatAktør>> brukes.
...
|Eksempel| Se eksemplene i <<PrivatAktør>>.
|===
