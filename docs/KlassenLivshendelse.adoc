...
|Anvendelse|Brukes til å representere en viktig https://data.norge.no/concepts/9b19d5ce-87b3-4584-a875-e7cff3ad6740[livshendelse] hos en innbygger som kan utløse behov for (offentlig) tjeneste.
