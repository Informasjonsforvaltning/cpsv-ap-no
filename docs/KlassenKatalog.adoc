...
|Anvendelse| Egenskapen brukes til å oppgi fritekst-beskrivelse av innholdet i katalogen. Gjentas når beskrivelsen finnes i flere ulike språk.
...
|URI|dct:title
|Range|rdf:langString
|Anvendelse| Egenskapen brukes til å oppgi navnet på katalogen. Gjentas når navnet finnes i flere ulike språk.
...
|Anvendelse| Egenskapen brukes til å oppgi språk som brukes i tekstlige metadata som beskriver innholdet i katalogen. Gjentas hvis metadata er gitt i flere språk.
...
|Usage note|This property represents the date of first publication of a Catalogue. This property should be typed as xsd:date or xsd:dateTime.
|Multiplisitet|0..1
|Kravnivå|Anbefalt/Recommended
|Merknad | Norsk utvidelse: Ikke eksplisitt spesifisert i CPSV-AP.
|Remark | Norwegian extension: Not explicitly specified in CPSP-AP.
...
|URI|dct:isPartOf
|Range|dcat:Catalog
|Anvendelse| Egenskapen brukes til å referere til en beslektet katalog som denne katalogen fysisk eller logisk er inkludert i.
