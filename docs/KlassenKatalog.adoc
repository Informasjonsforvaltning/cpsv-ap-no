...
image::images/KlassenKatalog.png[alt="UML-diagram med klassen Katalog, dens egenskaper og dens relasjoner til fire andre klasser. Innholdet i diagrammet er forklart i teksten."]
...
| Eksempel |  https://data.norge.no/nb/catalogs/public-services-and-events[Tjeneste- og hendelsesdelen av Felles datakatalog &#x29C9;, window="_blank", role="ext-link"] er en katalog over tjenester og hendelser.
|===
...
| Verdiområde / _Range_ | <<Tjeneste, cpsvno:Service>>, <<OffentligTjeneste, cpsv:PublicService>>, <<LovpålagtTjeneste, cpsvno:StatutoryService>>
...
Eksempel i RDF Turtle:
-----
<eksTjenestekatalog> a dcat:Catalog ;
...
| Subegenskap av / _Subproperty of_ | dct:hasPart
| Verdiområde / _Range_ | <<Hendelse, cv:Event>>, <<Livshendelse, cv:LifeEvent>>, <<Virksomhetshendelse, cv:BusinessEvent>>
...
| Multiplisitet / _Multiplicity_ | 0..1
| Kravnivå / _Requirement level_ | Anbefalt / _Recommended_
| Merknad 1 / _Note 1_ |Verdien SKAL velges fra EUs kontrollerte vokabular https://op.europa.eu/en/web/eu-vocabularies/concept-scheme/-/resource?uri=http://publications.europa.eu/resource/authority/licence[Lisens &#x29C9;, window="_blank", role="ext-link"], når lisensen som brukes finnes i vokabularet.
...
| URI | dct:isPartOf
| Verdiområde / _Range_ | <<Katalog, dcat:Catalog>>
