...
image::images/KlassenTidsenhet.png[alt="UML-diagram med klassen Tidsenhet og dens egenskaper. Innholdet i diagrammet er forklart i teksten."]
...
<exNormalMondayOpeningHours> a time:TemporalEntity; # tidsenhet
   time:hasBeginning <exTimeInstantMonday0800>; # starttidspunkt
   time:hasEnd <exTimeInstantMonday1600>; # slutttidspunkt
   cv:frequency <http://publications.europa.eu/resource/authority/frequency/WEEKLY>; # frekvens
   dct:description "normal Monday opening hours"@en, "normal åpningstid på mandager"@nb; # beskrivelse
   .
<exTimeInstantMonday0800> a time:Instant; # tidspunkt
   time:inDateTime <exDateTimeDescriptionMonday0800> ; # tidspunktbeskrivelse
   .
<exDateTimeDescriptionMonday0800> a time:DateTimeDescription; # tidspunktbeskrivelse
   time:unitType time:unitMinute; # enhetstype
   time:hour 8; # time
   time:minute 0; # sekund
   time:dayOfWeek time:Monday; # dag i uken
   .
<exTimeInstantMonday1600> a time:Instant; # tidspunkt
   time:inDateTime <exDateTimeDescriptionMonday1600> ; # tidspunktbeskrivelse
   .
<exDateTimeDescriptionMonday1600> a time:DateTimeDescription; # tidspunktbeskrivelse
   time:unitType time:unitMinute; # enhetstype
   time:hour 16; # time
   time:minute 0; # sekund
   time:dayOfWeek time:Monday; # dag i uken
...
<exNormalTuesdayOpeningHours> a time:TemporalEntity; # tidsenhet
   # se tilsvarende eksempler under <exNormalMondayOpeningHours> 
   .

<exNormalWednesdayOpeningHours> a time:TemporalEntity; # tidsenhet
   # se tilsvarende eksempler under <exNormalMondayOpeningHours> 
   .

<exNormalThursdayOpeningHours> a time:TemporalEntity; # tidsenhet
   # se tilsvarende eksempler under <exNormalMondayOpeningHours> 
   .

<exNormalFridayOpeningHours> a time:TemporalEntity; # tidsenhet
   # se tilsvarende eksempler under <exNormalMondayOpeningHours> 
   .
-----
...
-----
<exServiceChannelWeb> a cv:Channel; # tjenestekanal
   dct:type <http://data.europa.eu/snb/com-channel/b37115f83e>; # type = Web
   cv:openingHours <exTwentyfourSevenOpeningHours>; # åpningstid
   . 

<exTwentyfourSevenOpeningHours> a time:TemporalEntity; # tidsenhet
   time:hasBeginning <exTimeInstant0000>; # starttidspunkt
   time:hasEnd <exTimeInstant2400>; # slutttidspunkt
   cv:frequency <http://publications.europa.eu/resource/authority/frequency/DAILY>; # frekvens
   dct:description "24/7 opening hours"@en, "døgnkontinuerlig åpning"@nb; # beskrivelse
   .
<exTimeInstant0000> a time:Instant; # tidspunkt
   time:inDateTime <exDateTimeDescription0000>; # tidspunktbeskrivelse
   .
<exDateTimeDescription0000> a time:DateTimeDescription; # tidspunktbeskrivelse
   time:unitType time:unitMinute; # enhetstype
   time:hour 0; # time
   time:minute 0; # minutt
   .
<exTimeInstant2400> a time:Instant; # tidspunkt
   time:inDateTime <exDateTimeDescription2400>; # tidspunktbeskrivelse
   .
<exDateTimeDescription2400> a time:DateTimeDescription; # tidspunktbeskrivelse
   time:unitType time:unitMinute; # enhetstype
   time:hour 24; # time
   time:minute 0; # minutt
   .
...
=== Valgfrie egenskaper for klassen _Tidsenhet_ [[Tidsenhet-valgfri-egenskaper]]
...
==== Tidsenhet – frekvens (cv:frequency) [[Tidsenhet-frekvens]]
[cols="30s,70d"]
|===
