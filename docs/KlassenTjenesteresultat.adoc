...
image::images/KlassenTjenesteresultat.png[alt="UML-diagram med klassen Tjenesteresultat, dens egenskaper og dens relasjon til to andre klasser. Norske utvidelser er gulet ut. Innholdet i diagrammet er forklart i teksten."]
