...
==== Åpningstid – dager i uka (schema:dayOfWeek) [[Åpningstid-dager-i-uka]]
...
==== Åpningstid – gyldig fra og med (schema:validFrom) [[Åpningstid-gyldig-fra-og-med]]
...
==== Åpningstid – gyldig til og med (schema:validThrough) [[Åpningstid-gyldig-til-og-med]]
