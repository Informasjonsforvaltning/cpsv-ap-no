...
=== Obligatoriske egenskaper for klassen Katalog [[Katalog-obligatoriske-egenskaper]]
...
=== Anbefalte egenskaper for klassen Katalog [[Katalog-anbefalte-egenskaper]]
...
=== Valgfrie egenskaper for klassen Katalog [[Katalog-valgfrie-egenskaper]]
