...
image::images/KlassenRegulativRessurs.png[alt="UML-diagram med klassen Regulativ ressurs og dens egenskaper. Innholdet i diagrammet er forklart i teksten."]
...
==== Regulativ ressurs – relatert regulativ ressurs (dct:relation) [[RegulativRessurs-relatert-regulativ-ressurs]]
