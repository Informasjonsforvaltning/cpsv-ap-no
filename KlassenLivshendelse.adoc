...
|Beskrivelse|Brukes til å representere en viktig https://data.norge.no/concepts/9b19d5ce-87b3-4584-a875-e7cff3ad6740[livshendelse]+++<u>+++ hos en innbygger+++</u>+++ som kan utløse behov for offentlig tjeneste.
...
|Merknad|For hendelser i en virksomhet skal Klassen Virksomhetshendelse (cv:BusinessEvent) brukes.
...
|Merknad1|Norsk utvidelse: Kravsnivå endret fra valgfri til anbefalt
