...
image::images/KlassenVirksomhetshendelse.png[alt="UML-diagram med klassen Virksomhetshendelse, dens egenskaper og dens relasjoner til fire andre klasser. Innholdet i diagrammet er forklart i teksten."]
...
==== Virksomhetshendelse – kontaktpunkt (cv:contactPoint) [[Virksomhetshendelse-kontaktpunkt]]
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi kontaktpunkt(er) vedrørende _bekrivelsen_ av hendelsen. 

_This property specifies contact points for the description of the event._  
...
==== Virksomhetshendelse – kan utløse behov for (cpsvno:mayTriggerNeedFor) [[Virksomhetshendelse-kan-utløse-behov-for]]
...
| Merknad / _Note_ | Norsk utvidelse: Ikke eksplisitt spesifisert i CPSV-AP. Begrunnelse: det er behov for å kunne referere til begrep som er viktig for å forstå hendelsen.

_Norwegian extension: Not explicitly specified in CPSV-AP._
|===

==== Virksomhetshendelse – er beskrevet ved (cccevno:isDescribedBy) [[Virksomhetshendelse-er-beskrevet-ved]]
...
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
| Merknad / _Note_ | Norsk utvidelse: Verdien SKAL velges fra det felles kontrollerte vokabularet https://data.norge.no/vocabulary/business-event-type[Virksomhetshendelsestype &#x29C9;, window="_blank", role="ext-link"], når verdien finnes i vokabularet.

__Norwegian extension: The value MUST be chosen from the common controlled vocabulary https://data.norge.no/vocabulary/business-event-type[Business event type &#x29C9;, window="_blank", role="ext-link"], when the value is in the vocabulary.__
|===
