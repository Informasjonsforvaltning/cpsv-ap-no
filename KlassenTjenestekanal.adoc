...
| Merknad / _Note_ | Verdien BØR velges fra EUs kontrollerte vokabular for kommunikasjopnskanaltype https://op.europa.eu/en/web/eu-vocabularies/concept-scheme/-/resource?uri=http://data.europa.eu/snb/com-channel/25831c2[Tjenestekanaltype &#x29C9;, window="_blank", role="ext-link"], når verdien finnes i vokabularet.

__The value MUST be chosen from EU's controlled vocabulary https://op.europa.eu/en/web/eu-vocabularies/concept-scheme/-/resource?uri=http://data.europa.eu/snb/com-channel/25831c2[Communication channel type &#x29C9;, window="_blank", role="ext-link"], when the value is in the vocabulary.__
...
<viaSkjemaportalen> a cv:Channel ;
   ...
   dct:type <http://data.europa.eu/snb/com-channel/b37115f83e> ; # web
   .
-----
...
| Verdiområde / _Range_ | <<Tidsenhet, time:TemporalEntity>>
...
==== Tjenestekanal – eies av (cv:ownedBy) [[Tjenestekanal-eies-av]]
...
==== Tjenestekanal – har adresse (vcard:hasAddress) [[Tjenestekanal-har-adresse]]
...
<personligOppmøte> a cv:Channel ;
   vcard:hasAddress <eksFysiskAdresse> ; .

<eksFysiskAdresse> a vcard:Address ;
...
==== Tjenestekanal – har dokumentasjonskrav (cv:hasInputType) [[Tjenestekanal-har-dokumentasjonskrav]]
...
| Anvendelse / _Usage note_ |  Egenskapen brukes til å spesifisere type dokumentasjon som er  spesifikt påkrevd for den aktuelle tjenestekanalen.

_This property is used to specify type of evidence that is required by the service channel._
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ |  Valgfri / _Optional_
...
==== Tjenestekanal – har e-post (vcard:hasEmail) [[Tjenestekanal-har-e-post]]
...
==== Tjenestekanal – har telefon (vcard:hasTelephone) [[Tjenestekanal-har-telefon]]
...
==== Tjenestekanal – har URL (vcard:hasURL) [[Tjenestekanal-har-URL]]
