...
<exAktør> a foaf:Agent ;
   foaf:name "Den beste restauranten AS"@nb ;
   dct:identifier " https://organization-catalogue.fellesdatakatalog.digdir.no/organizations/nnnnnnnnn" ;  .
-----
...
==== Aktør – har rolle i (cv:playsRole) [[Aktør-harRolleI]]
...
|Kravsnivå|Valgfri/Optional
|Merknad|
|Eksempel|Se under <<KnytteDeltagendeAktørerTilTjeneste>>.
|===

Eksempel i RDF Turtle: Se under <<KnytteDeltagendeAktørerTilTjeneste>>.
